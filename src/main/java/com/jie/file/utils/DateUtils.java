...
//--格式化日期start-----------------------------------------
     ...
     * @return
     */
    public static String calculationEn(LocalDateTime startTime, LocalDateTime endTime, List<String> dateList) throws Exception {
        if (startTime == null) {
    ...
    public static String calculation(LocalDate startDate, LocalDate endDate, List<String> dateList) throws Exception {
        if (startDate == null) {
    ...
    public static String calculationEn(LocalDate startDate, LocalDate endDate, List<String> dateList) throws Exception {
        if (startDate == null) {
            startDate = LocalDate.now();
        }
        if (endDate == null) {
